    ...
    <>
        <form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-500">
            ...
            <div className="flex flex-row items-center justify-center">
                <button className="px-10 mt-8 py-2 bg-pink-600 text-gray-50 font-light rounded-md text-lg flex flex-row items-center hover:bg-black shadow-lg shadow-pink-500/20 transition-all duration-300 hover:-translate-y-[2px] hover:shadow-blue-800/20">
                Send
                    <svg width="24" height="24" viewBox="0 0 24 24" className="text-white ml-2 mt-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
